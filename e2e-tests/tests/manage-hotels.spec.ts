...
//   // Assert that the "Sign in Successful!" message is visible
...
//     path.join(__dirname, "files", "p-1.jpg"),
//     path.join(__dirname, "files", "p-2.jpg"),
//     path.join(__dirname, "files", "p-3.jpg"),
//     path.join(__dirname, "files", "p-4.jpg"),
//     path.join(__dirname, "files", "p-5.jpg"),
//   ]);
